...
| [grok-build-personal-assistant](https://github.com/HermeticOrmus/grok-build-personal-assistant) | Turn Grok Build into your always-on personal computer assistant (daily-brief, task-orchestrator, comms, memory + agents/MCP) |
